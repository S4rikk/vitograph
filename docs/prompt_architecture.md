...
> **Дата актуальности:** 29 апреля 2026 (обновлено: Темпоральные правила v1.2.0)
...
## 6. Темпоральные правила и Защита от Амнезии (Temporal Context Engine)

В версии 1.2.0 внедрен Темпоральный Движок для активных навыков. `withActiveSkills()` получает параметр `userDateStr` (timezone-aware) и генерирует предрасчёт дней активности:
