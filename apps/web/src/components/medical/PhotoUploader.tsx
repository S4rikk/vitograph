  ...
  return (
    <div className="flex flex-col p-6 bg-surface rounded-3xl border border-border shadow-[0_8px_30px_rgb(0,0,0,0.04)] h-full transition-all duration-300 hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)]">
      ...
      <div className="flex flex-col gap-2 mt-auto">
        {isUploading ? (
          <div className="cursor-wait opacity-80 flex min-h-[52px] w-full items-center justify-center rounded-2xl bg-surface-muted border border-border px-5 font-bold text-ink-faint transition-all text-center">
          ...
          <>
            ...
            <label
              ...
              className="cursor-pointer flex min-h-[52px] w-full items-center justify-center rounded-2xl bg-primary-500/10 hover:bg-primary-500/20 active:scale-[0.98] px-5 font-bold text-primary-600 transition-all text-center group"
            >
            ...
            <label
              ...
              className="cursor-pointer flex min-h-[52px] w-full items-center justify-center rounded-2xl bg-surface border border-border hover:bg-surface-hover active:scale-[0.98] px-5 font-bold text-ink-muted transition-all text-center group"
            >
              <span className="flex items-center gap-2">
                <svg className="w-5 h-5 transition-transform group-hover:scale-110" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
